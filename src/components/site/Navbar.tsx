  ...
  return (
    <header
      className={`sticky top-0 z-50 border-b backdrop-blur-xl ${
        homePage
          ? "border-[#F4B8C2]/35 bg-transparent"
          ...
          {links.map(([to, key]) => (
            <Link
              ...
              className={`rounded-full px-3 py-2.5 text-sm font-semibold transition-colors ${
                homePage
                  ? "text-[#713B49] hover:bg-[#F4DDE3] hover:text-[#5F2F3B]"
        ...
        <div className="ms-auto flex items-center gap-2">
          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-2 text-xs font-semibold ${
              homePage
                ? "border-[#F4B8C2]/60 bg-[#F4B8C2] text-[#6F3440] hover:bg-[#f8c5cd]"
          ...
          >
            <Globe
              className={`h-4 w-4 ${
                homePage ? "text-[#6F3440]" : "text-primary"
              }`}
              aria-hidden="true"
            />
          ...
          <Link
            to="/booking"
            className={`hidden rounded-full px-5 py-3 text-sm font-bold shadow-[0_12px_24px_-16px_#c27a86] transition-transform hover:-translate-y-0.5 sm:inline-flex ${
              homePage
                ? "bg-[#F3B0BC] text-[#6F3440] hover:bg-[#f8c5cd]"
          ...
          <button
            ...
            className="inline-flex rounded-full border border-[rgba(113,59,73,0.20)] bg-[rgba(255,255,255,0.75)] p-2 text-[#713B49] shadow-[0_3px_10px_rgba(83,35,50,0.10)] transition-colors hover:bg-[#F4DDE3] active:bg-[#F4DDE3] lg:hidden"
            aria-expanded={open}
      ...
      >
        <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-4 py-3 sm:px-6">
          ...
          <Link
            to="/booking"
            onClick={() => setOpen(false)}
            className={`mt-1 rounded-full px-4 py-3 text-center text-sm font-bold ${
              homePage
                ? "bg-[#F3B0BC] text-[#6F3440]"
                : "bg-primary text-primary-foreground"
            }`}
          >
            {t.nav.book}
