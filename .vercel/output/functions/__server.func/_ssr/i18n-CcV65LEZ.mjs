...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-CcV65LEZ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var PHONE = "0598291081";
var WHATSAPP_URL = "https://wa.me/972598291081";
var INSTAGRAM_HANDLE = "-----";
var FACEBOOK_NAME = "-----";
var MAPS_URL = "https://www.google.com/maps?q=31.355090,34.301244";
var MAPS_EMBED_URL = "https://www.google.com/maps?q=31.355090,34.301244&output=embed";
var serviceKeys = [
	"denture",
	"rootcanal",
	"fillings",
	...
	ar: {
		...
		why: {
			...
			items: [
				{
					title: "إشراف طبي",
					desc: "العلاجات تتم تحت إشراف كادر طبي مختص."
				},
				{
					title: "اهتمام بالحالة",
					desc: "تقييم كل حالة وتحديد الإجراء المناسب لها."
				},
				{
					title: "بيئة مريحة",
					desc: "الحرص على تجربة منظمة ومريحة أثناء الزيارة."
				},
				{
					title: "تواصل سهل",
					desc: "إمكانية التواصل والاستفسار عن الحالات والمواعيد بسهولة."
				}
			]
		},
		cta: {
		...
		footer: {
			...
			disclaimer: "المعلومات الموجودة في الموقع لأغراض التعريف بالخدمات والتواصل ولا تغني عن التقييم الطبي المباشر."
		},
		mobile: {
			call: "اتصال",
			book: "حجز موعد",
	...
	en: {
		...
		why: {
			...
			items: [
				...
				{
					title: "Easy contact",
					desc: "You can easily get in touch about cases and appointments."
				}
			]
		},
		cta: {
		...
		footer: {
			...
			disclaimer: "The information on this site is for introducing the services and for contact purposes, and does not replace a direct medical assessment."
		},
		mobile: {
			call: "Call",
			book: "Book",
...
//#endregion
export { MAPS_URL as a, scrollToSection as c, MAPS_EMBED_URL as i, serviceKeys as l, INSTAGRAM_HANDLE as n, PHONE as o, LanguageProvider as r, WHATSAPP_URL as s, FACEBOOK_NAME as t, useLanguage as u };
